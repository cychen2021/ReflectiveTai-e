...
public class KnownRecv {

    public static void main(String[] args) throws Exception {
        invokeOneArg(unknown("H"), new Class[]{Object.class}, H.class.newInstance());
        invokeOneArg(unknown("H"), new Class[]{String.class}, H.class.newInstance());
    }
